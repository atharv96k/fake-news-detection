...
export default function DetectionPage() {
  ...
  const steps = [
    { text: "Processing Text", icon: <FileText className="w-7 sh-7 text-black-500" /> },
    { text: "Fetching Evidence", icon: <Globe className="w-7 h-7 text-black-500" /> },
    { text: "AI Analysis", icon: <BrainCircuit className="w-7 h-7 text-black-500" /> },
    { text: "Final Verdict", icon: <BadgeCheck className="w-7 h-7 text-black-500" /> },
  ];
